...
class CDGMCatalog:
    ...
    def __init__(self, fname='CDGM.xls'):
        ...
        self.index_col_offset = colnames.index('nt')
    ...
    def glass_index(self, gname):
        ...
        if gname in gnames:
            ...
            logging.info('CDGM glass %s not found', gname)
            raise ge.GlassNotFoundError("CDGM", gname)
    ...
    def data_index(self, dname):
        if dname in self.xl_data.row_values(self.data_header, 0):
            ...
            logging.info('CDGM glass data type %s not found', dname)
            raise ge.GlassDataNotFoundError("CDGM", dname)
...
class CDGMGlass:
    ...
    def __repr__(self):
        return 'CDGM ' + self.name() + ': ' + self.glass_code()
